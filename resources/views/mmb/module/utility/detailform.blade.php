        ...
        <thead>
			<tr>
				...
				<?php foreach ($tableGrid as $t) :
					if($t['view'] =='1'):
						echo '<th align="'.$t['align'].'">'.\App\Library\SiteHelpers::activeLang($t['label'],(isset($t['language'])? $t['language'] : array())).'</th>';
					endif;
				endforeach; ?>
				<th width="70"></th>
			  </tr>
					...
					<td width="50"> <?php echo $n;?>  </td>
					 ...
					 <?php foreach ($tableGrid as $field) :
						 ...
						 <td align="<?php echo $field['align'];?>">
							...
							echo \App\Library\AjaxHelpers::gridFormater($row->$field['field'], $row , $field['attribute'],$conn);?>
