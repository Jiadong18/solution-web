...
<div class="box box-primary">
	...
	<div class="box-body">
@endif
			{!! Form::open(array('url'=>'hotelfacilities/save/'.\App\Library\SiteHelpers::encryptID($row['hotelfacilityID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'hotelfacilitiesFormAjax')) !!}
			<div class="col-md-12">
