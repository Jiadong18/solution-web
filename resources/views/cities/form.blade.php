...
<div class="box box-primary">
	...
	<div class="box-body">
@endif
			{!! Form::open(array('url'=>'cities/save/'.\App\Library\SiteHelpers::encryptID($row['cityID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'citiesFormAjax')) !!}
			<div class="col-md-12">
