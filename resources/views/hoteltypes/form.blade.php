...
<div class="box box-primary">
	...
	<div class="box-body">
@endif
			{!! Form::open(array('url'=>'hoteltypes/save/'.\App\Library\SiteHelpers::encryptID($row['hoteltypeID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'hoteltypesFormAjax')) !!}
			<div class="col-md-12">
