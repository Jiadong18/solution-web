			...
			<tr>
				...
				<?php foreach ($tableGrid as $t) :
					if($t['view'] =='1'):
						...
						{
							echo '<th align="'.$t['align'].'" width="'.$t['width'].'">'.\\App\Library\SiteHelpers::activeLang($t['label'],(isset($t['language'])? $t['language'] : array())).'</th>';
						}
					endif;
				endforeach; ?>
			  ...
			  @endif
                ...
                <tr class="editable" id="form-{{ $row->tourdateID }}">
				 ...
				 <td data-values="action" data-key="<?php echo $row->tourdateID ;?>"  >
					{!! \App\Library\AjaxHelpers::buttonAction('calendartourdates',$access,$id ,$setting) !!}
					{!! \App\Library\AjaxHelpers::buttonActionInline($row->tourdateID,'tourdateID') !!}
