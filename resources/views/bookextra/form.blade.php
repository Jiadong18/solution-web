...
<div class="box box-primary">
	...
	<div class="box-body">
@endif
			{!! Form::open(array('url'=>'bookextra/save/'.\App\Library\SiteHelpers::encryptID($row['bookextraID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'bookextraFormAjax')) !!}
			<div class="col-md-12">
