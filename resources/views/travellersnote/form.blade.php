...
<div class="box box-primary">
	...
	<div class="box-body">
@endif
			{!! Form::open(array('url'=>'travellersnote/save/'.\App\Library\SiteHelpers::encryptID($row['travellers_noteID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'travellersnoteFormAjax')) !!}
			<div class="col-md-12">
