...
<div class="box box-primary">
	...
	<div class="box-body">
@endif
			{!! Form::open(array('url'=>'suppliertypes/save/'.\App\Library\SiteHelpers::encryptID($row['suppliertypeID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'suppliertypesFormAjax')) !!}
			<div class="col-md-12">
