...
<div class="box box-primary">
	...
	<div class="box-body">
@endif
			{!! Form::open(array('url'=>'optionaltours/save/'.\App\Library\SiteHelpers::encryptID($row['optionaltourID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'optionaltoursFormAjax')) !!}
			<div class="col-md-12">
