...
<div class="box box-primary">
	...
	<div class="box-body">
@endif
			{!! Form::open(array('url'=>'hotelcategories/save/'.\App\Library\SiteHelpers::encryptID($row['hotelcategoryID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'hotelcategoriesFormAjax')) !!}
			<div class="col-md-12">
