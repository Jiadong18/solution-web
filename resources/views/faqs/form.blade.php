...
<div class="box box-success ">
	<div class="box-header with-border"> <h4>{{ Lang::get('core.addnewfaq') }}</h4></div>
	<div class="box-body"> 	
...
<div class="col-md-12">
								  ...
								  <div class="form-group  " >
									<label for="Name" class=" control-label col-md-4 text-left"> {{ Lang::get('core.faqname') }}<span class="asterix"> * </span></label>
									<div class="col-md-6">
								  ...
								  <div class="form-group  " >
									<label for="Short Text" class=" control-label col-md-4 text-left"> {{ Lang::get('core.description') }}</label>
									<div class="col-md-6">
			...
			<div style="clear:both"></div>	
				  ...
				  <div class="form-group">
					...
					<button type="button" onclick="location.href='{{ URL::to('faqs?return='.$return) }}' " class="btn btn-success btn-sm ">  {{ Lang::get('core.sb_cancel') }} </button>
					</div>	  
