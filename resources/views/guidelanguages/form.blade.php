...
<div class="box box-primary">
	...
	<div class="box-body">
@endif
			{!! Form::open(array('url'=>'guidelanguages/save/'.\App\Library\SiteHelpers::encryptID($row['languageID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'guidelanguagesFormAjax')) !!}
			<div class="col-md-12">
