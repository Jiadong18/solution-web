...
<div class="box box-primary">
	...
	<div class="box-body">
@endif
			{!! Form::open(array('url'=>'roomtypes/save/'.\App\Library\SiteHelpers::encryptID($row['roomtypeID']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ','id'=> 'roomtypesFormAjax')) !!}
			<div class="col-md-12">
