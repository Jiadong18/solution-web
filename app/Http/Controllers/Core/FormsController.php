...
class FormsController extends Controller {
    ...
    function getConfiguration( Request $request, $ids)
    {
		...
		$i = 0; $forms = array();
		$i = 0 ;
		usort($configuration, "\App\Library\SiteHelpers::_sort");
    ...
    function postField( Request $request,$formID)
    {
        ...
        $new_field = array(
            "field"         => \App\Library\SiteHelpers::seoUrl($request->input('field')),
   ...
   function postReorder( Request $request , $ids )
   {
    ...
    function getRebuild( $id )
    {
		...
		$convert       = \App\Library\SiteHelpers::blend($form_template,$codes);
		// Render To Form
